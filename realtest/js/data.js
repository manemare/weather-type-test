...
const qnaList = [
  ...
  },
  {
    ...
    a: [
      { answer: '24시간 일상 생중계형 스토리', type: [0, 1, 2, 3, 4, 5, 6, 7] },
  ...
  {
    q: '5. 시험 공부 중 전혀 이해가 가지 않는 부분이 있다',
    a: [
...

  {
    ...
    a: [
      { answer: '얼마나 속상하면 이 시간에 전화를 했겠어. 위로해준다.', type: [0, 2, 4, 5, 8, 9, 12, 13] },
  ...
  },
  {
    q: '8. 공허함이 느껴질 땐',
    a: [
      { answer: '마시고 먹고! 시끄럽게 푼다', type: [3, 4, 5, 6, 11] },
      { answer: '친한 사람에게 속내를 털어놓는다', type: [0, 1, 2, 3, 7, 12, 13, 14] },
      { answer: '끝없는... 심연 속으로...', type: [8, 9, 10, 15] },
    ]
  },
  {
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '같은 주제로 3시간 토론이 가능한 연인', type: [3, 10, 15] },
    ]
  },
  {
    q: '11. 나의 이상형은',
